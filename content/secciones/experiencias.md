...
**Herramientas y Tecnologías:**  
`Python` · `GeoPandas` · `Pandas` · `Folium` · `Jupyter Books` · `Capacitación Técnica`



### Técnico de Monitoreo Forestal
**Instituto de Conservación Forestal (ICF) / Centro de Información y Patrimonio Forestal (CIPF)**  
*Tegucigalpa, Honduras · Jul 2024 – Dic 2025*
...
**Herramientas y Tecnologías:**  
`Python` · `GDAL` · `PostGIS` · `Alertas GLAD` · `Gestión de Proyectos Institucionales`


### Técnico en Geomática
**Instituto de Conservación Forestal (ICF) / Programa Nacional de Reforestación (PNR)**  
*Tegucigalpa, Honduras · Jul 2023 – Jun 2024*
...
### Consultor de Sistemas de Información Geográfica
**Centro de Estudios Marinos**  
*Honduras · Nov 2023 – Ene 2024*
...
**Herramientas y Tecnologías:**  
`Google Earth Engine (GEE)` · `Python` · `ArcGIS` · `Análisis Multitemporal`



### Técnico de Campo para Asistencia Técnica
**AEPAS-H (Financiado por BID)**  
*Comayagua, Honduras · Jul 2022 – Dic 2022*
...
### Técnico FAO
**FAO - ICF**  
*Tegucigalpa, Honduras · Nov 2016 – Ago 2017*
...
**Herramientas y Tecnologías:**  
`Bases de Datos` · `Digitalización Cartográfica` · `Inventario Forestal`



### Especialista en Recursos Naturales y SIG
**ICF - HGPC**  
*Cuyamel, Omoa, Cortés · Feb 2016 – Jun 2016*
...
**Herramientas y Tecnologías:**  
`Planes de Manejo` · `Áreas Protegidas` · `Facilitación de Talleres` · `ONGs`



### Especialista SIG y Líder de Cuadrilla
...
- **Análisis Espacial y Zonificación:** Análisis de la evolución del uso del suelo en las Áreas Protegidas de la Zona Sur, proponiendo uso potencial y zonificación para el Subsistema (SAPZsurH).
...
**Herramientas y Tecnologías:**  
`Análisis Multitemporal de Uso de Suelo` · `Zonificación` · `Levantamiento Biofísico` · `Nomenclatura SINAPH`

### Jefe Oficina Forestal Municipal
**Municipalidad de San Juan de Ojojona**  
*Ojojona, Honduras · May 2013 – Abr 2015*
...
**Herramientas y Tecnologías:**  
`Gestión Municipal` · `Permisos Forestales` · `Protección de Microcuencas`
